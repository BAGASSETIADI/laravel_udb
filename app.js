...
var matakuliahkurikulumRouter = require('./routes/matakuliahkurikulum');
var satuanpendidikanRouter = require('./routes/satuanpendidikan');
var angkatanRouter = require('./routes/angkatan');
var programStudiRouter = require('./routes/programstudi');
var jenjangpendidikanRouter = require('./routes/jenjangpendidikan');
...
app.use('/matakuliahkurikulum', matakuliahkurikulumRouter);
app.use('/satuanpendidikan', satuanpendidikanRouter);
app.use('/angkatan', angkatanRouter);
app.use('/programstudi', programStudiRouter);
app.use('/jenjangpendidikan', jenjangpendidikanRouter);
